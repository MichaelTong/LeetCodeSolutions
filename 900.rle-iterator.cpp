...
// @lc code=start
/**
 * Build the sequence at the class initialization
 * Or for a better performance, store A as it is but remove all the numbers with
 * zero length.
 * for next(), reduce the length accordingly in A.
 */
class RLEIterator {
    int idx;
    vector<int> A;
